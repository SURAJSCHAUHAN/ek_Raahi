    ...
    <div id='hero' className='relative'>
      <div className='h-screen w-full flex text-[#E6E0D2] text-5xl font-semibold items-center justify-between bg-[#1E1E1E]'>
            <div className='pl-32 w-2/5 leading-normal mt-32'>
                  <p>Discover Your Signature Look at Maxim<span className='text-red-600'>Fashion</span> </p>
                  <p>Unleash Your Western Side</p>
            </div>
            <div className='pr-14 pl-24 w-2/5 leading-normal mt-36'>
                  <p>Fashion Forward, Always: Shop Masculine Trends with MAX<span className='text-red-600'>IM</span></p>
            </div>
      </div>
      ...
      <div  className={`absolute top-0  h-screen w-3/5 flex flex-col justify-center items-center bg-cover text-white left-0 ${!clicked ? 'rounded-r-[40px]  bg-[url("/image6.jpeg")] transform -translate-x-2 duration-1000': 'rounded-l-[40px] bg-[url("/image5.jpeg")] transform translate-x-[66.5%] duration-1000' }`}>
